...
<div class="mb-3">
<input type="text" class="form-control" name="Uemail" placeholder="Enter your email">
</div>
<div class="mb-3">
...
<div class="mt-4" name="hidden-panel" id="hidden-panel" >
    ...
    <input type="text" name="haddress" id="country" class="form-control" placeholder="Hospital Address"/>
    
    <input type="text" name="hadminno" id="country" class="form-control" placeholder="Hospital Admin_NO."/>
